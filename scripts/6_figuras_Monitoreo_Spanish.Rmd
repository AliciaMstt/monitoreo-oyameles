...
Fig_2<-grid.arrange(p_a, p_c, p_b, p_d, ncol = 2)
ggsave("../outputs/Fig_2_spanish.png", plot= Fig_2,
       width = 16, height = 12,
       dpi = 600)
```
...
ggsave("../outputs/Fig_3_spanish.png", plot= p3,
       width = 16, height = 12,
       dpi = 600)
...
```{r, message=FALSE, fig.height=12, fig.width=16}
Fig_4<-grid.arrange(p4_a, p4_c, p4_b, p4_d, ncol = 2)
ggsave("../outputs/Fig_4_spanish.png", plot= Fig_4,
       width = 16, height = 12,
       dpi = 600)
...
Fig_5<-grid.arrange(fig5a, fig5b, fig5c, ncol = 1)
ggsave("../outputs/Fig_5_spanish.png", plot= Fig_5,
       width = 16, height = 20,
       dpi = 600)
...
ggsave("../outputs/Fig_S8_spanish.png", plot= p_d,
       width = 16, height = 10,
       dpi = 600)
...
p_satmap <- p_satmap +geom_scatterpie(data=parcelas_tidy,
                aes(x=X_coordinates_longitude,
                    y=X_coordinates_latitude,
                    group=plot),
                pie_scale = 1.5,
...
ggsave("../outputs/Fig_S11_spanish.png", plot= p_satmap,
       width = 16, height = 10,
       dpi = 600)
```
...
p
ggsave("../outputs/Fig_S12_spanish.png", plot= p,
       width = 16, height = 10,
       dpi = 600)
