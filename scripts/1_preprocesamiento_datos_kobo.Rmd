...
parcelas<- select(parcelas, 
                  -dominant_spp.Pinus_ayacauite:dominant_spp_others,
                  -X_submission_time)
```
...
Save data
```{r}
write(muestreo, file="../data/kobo/muestreo_dic2020_tidy.txt", sep = "\t")
write(parcelas, file="../data/kobo/parcelas_dic2020_tidy.txt", sep = "\t")
```
