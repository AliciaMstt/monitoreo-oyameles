...
```{r, message=FALSE, echo=FALSE, warning=FALSE, fig.height=15, fig.width=15}
...
```{r, message=FALSE, echo=FALSE, fig.height=5, fig.width=9}
...
```{r, message=FALSE, echo= FALSE, fig.height=9, fig.width=11}
...
```{r, message=FALSE, echo= FALSE, fig.height=9, fig.width=11}
p <- filter(muestreo_tidy, tree_heigth<15) %>% 
     ggplot(.) +
     scale_fill_manual(values= my_cols, breaks = desired_order,
                    labels= spanish_labels,
                    name= "Estado de salud del árbol") +
...
pnodos <- p + geom_histogram(aes(x=tree_nodes, 
    ...
    theme(text = element_text(size = 20)) +
    ggtitle("Estado de salud de los árboles según su número de nodos") + 
     theme(plot.title = element_text(lineheight=1.1, face="bold"))
pnodos
...
```{r, message=FALSE, echo= FALSE, fig.height=9, fig.width=13}
...
filter(muestreo_tidy, tree_heigth<15) %>% 
     ggplot(.) +
