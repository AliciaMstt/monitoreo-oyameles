...
el estado de salud del aárbol es independiente de su condición de reforestación
H:árbolres dañados por ozono dependen de si fueron reforestados
...
my_comparisons <- list(c("0%", "less than 10%"), c("0%", "10 to 40%"), c("0%", "40 to 50%"),
                        ...
                        c("less than 10%", "10 to 40%"), c("less than 10%", "40 to 50%"),
                        c("less than 10%", "50 to 70%"), c("less than 10%", "more than 70%"),
                        c("10 to 40%", "40 to 50%"),c("10 to 40%", "50 to 70%"), 
                        c("10 to 40%", "more than 70%"),
                        c("40 to 50%", "50 to 70%"), c("40 to 50%", "more than 70%"),
                        c("50 to 70%", "more than 70%"))
