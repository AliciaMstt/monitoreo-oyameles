...
glm_1_coh<-glm(tree_heigth ~ tree_nodes*tree_health_simplified*tree_exposition * reforested * tree_exposition * plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_1_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_1_coh)
...
glm_2_coh<-glm(tree_heigth ~ tree_nodes+tree_health_simplified + tree_exposition + reforested + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_2_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_2_coh)
...
glm_3_coh<-glm(tree_heigth ~ tree_nodes+tree_health_simplified + reforested + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_3_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_3_coh)
...
glm_4_coh<-glm(tree_heigth ~ tree_nodes+tree_health_simplified + tree_exposition + plot , data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_4_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_4_coh)
...
########################
# Model all independent variables WITH health status interaction WITHOUT reforested and tree exposition data
glm_5_coh<-glm(tree_heigth ~ tree_nodes + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_5_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_5_coh)
...
########################
glm_6_coh<-glm(tree_heigth ~ tree_nodes*tree_health_simplified*tree_exposition + reforested + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_6_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_6_coh)
...
########################
glm_7_coh<-glm(tree_heigth ~ tree_nodes*tree_health_simplified*reforested + tree_exposition + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_7_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_7_coh)
...
########################
glm_8_coh<-glm(tree_heigth ~ tree_nodes*tree_health_simplified*tree_exposition+reforested + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_8_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_8_coh)
...
########################
glm_9_coh<-glm(tree_heigth ~ tree_nodes*tree_health_simplified*(tree_exposition+reforested) + plot, data = condition_model_all_C, family = Gamma(link = "log"))
summary(glm_9_coh)
#### PLOT MODEL
par(mfrow =c(2,2))
plot(glm_9_coh)
